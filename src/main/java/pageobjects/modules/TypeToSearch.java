...
public class TypeToSearch {
    ...
    @FindBy(id = "search-label-type")
    private WebElement typeToSearch;
    @FindBy(id = "keywords")
    private WebElement typeToSearchTextField;
    @FindBy(id = "recommended-contents-section")
    private WebElement recommendedContentsSection;
    @FindBy(id = "recommended-content")
    private WebElement recommendedContent;
    @FindBy(id = "close-smart-search")
    private WebElement typeToSearchCloseButton;
    @FindAll(@FindBy(css = "div#recommended-content div[id*='search-results']"))
    private List<WebElement> searchResults;

    public TypeToSearch(WebDriver driver) {
