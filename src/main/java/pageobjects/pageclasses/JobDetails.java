...
public class JobDetails {
    ...
    public String href;
    @FindBy(css = "span.top-links a:nth-of-type(1)")
    public WebElement topApplyButton;
    @FindBy(css = "div.bottom-links a:nth-of-type(1)")
    public WebElement bottomApplyButton;
    @FindBy(css = "span.top-links a:nth-of-type(2)")
    public WebElement topGetReferredButton;
    @FindBy(css = "div.bottom-links a:nth-of-type(2)")
    public WebElement bottomGetReferredButton;
    @FindBy(css = "span.top-links a:nth-of-type(3)")
    public WebElement topAbacusSaveJobButton;
    @FindBy(css = "div.bottom-links a:nth-of-type(3)")
    public WebElement bottomAbacusSaveJobButton;
    @FindBy(css = "span.top-links a:nth-of-type(2)")
    public WebElement topSaveJobButton;
    @FindBy(css = "div.bottom-links a:nth-of-type(2)")
    public WebElement bottomSaveJobButton;
    @FindBy(css = "span.top-links > div")
    public WebElement topShareButton;
    @FindBy(css = "div.bottom-links > div")
    public WebElement bottomShareButton;
    @FindBy(css = "a.collapse-toggle span:nth-of-type(2)")
    public WebElement linkJobDescription;
    @FindBy(id = "0-collapsible")
    public WebElement jobDescription;
    @FindBy(css = "a[href='#1-collapsible']")
    public WebElement linkBasicQualification;
    @FindBy(id = "1-collapsible")
    public WebElement basicQualification;
    @FindBy(id = "maincontent-hero")
    public WebElement pageTitle;
    @FindBy(css = ".job-title > h1")
    public WebElement jobTitle;
    @FindBy(css = ".job-location.color-black")
    public WebElement jobLocation;
    @FindBy(css = ".job-number.color-black")
    public WebElement jobID;
    @FindBy(css = "div[class='display-boxshadow bg-color-white floatcontainer ']")
    public WebElement blockJobOpenings;
    @FindBy(css = "input[type='checkbox']")
    private WebElement privacyStatementCheckbox;
